...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Polynom pm= new Polynom ("x^2+2");
			
				pm.graph();
			
			
			//Polynom pm1= new Polynom ("0.2x^4+-1.5x^3+3.0x^2+-x+-5");
...
//			polynomCopy();
	...
	public static void testAddPolynom()
	{
		...
		Polynom p1 = new Polynom("2x+9x^5+4x^2+8");
		System.out.println(p1);
		Polynom p2= new Polynom("5x^7+-5x^7+2");
	...
	{
		Polynom p = new Polynom("1x+5x^7+4x^2+1");
		Polynom p1= new Polynom("5x^7+-3x^2+2");
		p.substract(p1);
		System.out.println("get:2x+7x^2-1");
	...
	{
		Polynom p = new Polynom("-2x+5x^7+4x^2");
		Polynom p1= new Polynom("3x^2+2x");
		p.multiply(p1);
	...
	public static void testDerivative() 
	{
		...
		Polynom p = new Polynom("2x+4x^8+-3x^5+8");
		Polynom p1= new Polynom("-5x^2+6x^9");
		System.out.println("need to get from p:2x^0+32x^7+-15x^4");
	...
	{
		Polynom p = new Polynom("2x+4x^8+-3x^5");
		Polynom p1 = new Polynom(p.toString());
