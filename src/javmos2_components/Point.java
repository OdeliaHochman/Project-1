...
public class Point extends JavmosComponent {
    ...
    public Point(GraphGUI gui, RootType type, double x, double y) {
        super(gui);
        this.type = type;
        this.x = x;
        this.y = y;
    ...
    public Ellipse2D.Double getPoint() {
        ...
        return point;
        //return point.contains(x - 4, y - 4) || point.contains(x, y) || point.contains(x + 4, y + 4) || point.contains(x - 4, y + 4);
    }
