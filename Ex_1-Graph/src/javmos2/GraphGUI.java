...
public final class GraphGUI {
    ...
    private final JFrame frame = new JFrame("Polynom Calculator");
...
//        configureComponent(minRangeField, CONTROL_PANEL_WIDTH / 3, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.BLACK, 25, domainRangeListener, "MIN_RANGE", inputBackgroundColor, displayBackgroundColor);
        ...
        configureComponent(quitButton, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, quitListener, "", displayBackgroundColor, displayForegroundColor);
...
//        rangeStepPanel.add(rang0eStepField);
...
//        controlPanel.add(maxRangeField);
    ...
    public static void Graph(String guiStr) 
  	{
    	GraphGUI Gjui=new GraphGUI(guiStr);
